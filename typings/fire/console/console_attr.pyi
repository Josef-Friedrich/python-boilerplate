...
from fire.console import console_attr_os as console_attr_os
from fire.console import text as text
...
class ConsoleAttr:
    def __init__(
        self, encoding: Incomplete | None = None, suppress_output: bool = False
    ) -> None: ...
    def Colorize(self, string, color, justify: Incomplete | None = None): ...
...
class Colorizer:
    def __init__(self, string, color, justify: Incomplete | None = None) -> None: ...
    ...
    def Render(self, stream, justify: Incomplete | None = None) -> None: ...

def GetConsoleAttr(encoding: Incomplete | None = None, reset: bool = False): ...
def ResetConsoleAttr(encoding: Incomplete | None = None): ...
def GetCharacterDisplayWidth(char): ...
def SafeText(data, encoding: Incomplete | None = None, escape: bool = True): ...
